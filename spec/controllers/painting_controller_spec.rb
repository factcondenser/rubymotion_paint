describe PaintingController do
  ...
  describe "#red_button" do
    it "is connected in the storyboard" do
      controller.red_button.should.not.be.nil
    end
  end

  describe "#yellow_button" do
    it "is connected in the storyboard" do
      controller.yellow_button.should.not.be.nil
    end
  end
  ...
  describe "#brown_button" do
    it "is connected in the storyboard" do
      controller.brown_button.should.not.be.nil
    end
  end
  ...
  describe "#select_color" do
    ...
    it "deselects the other colors" do
      ...
      controller.red_button.state.should == UIControlStateNormal
      controller.yellow_button.state.should == UIControlStateNormal
      controller.blue_button.state.should == UIControlStateNormal
      controller.brown_button.state.should == UIControlStateNormal
    end
  ...
  describe "#selected_color" do
    ...
    it "returns the correct color" do
      controller.selected_color.should == PaintingController::COLORS[:green]
    end
  end
